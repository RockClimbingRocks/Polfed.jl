...
"""
    calculate_eigenvectors!(convergenceinfo::ConvergenceInfo, factorization::KrylovFactorization, vecs::AbstractMatrix, ϕ::AbstractMatrix, idxs::AbstractVector) -> nothing

Build converged eigenvectors in original space from Krylov basis and selected
Ritz vectors.
"""
...
"""
    calculate_eigenvectors!_(vecs, krylovbasis, ϕ) -> nothing

Backend-specific eigenvector reconstruction kernels for different basis storage
representations.
"""
...
"""Single-matrix basis overload of `calculate_eigenvectors!_`."""
...
"""Vector-of-vectors basis overload of `calculate_eigenvectors!_`."""
...
"""Vector-of-blocks basis overload of `calculate_eigenvectors!_`."""
