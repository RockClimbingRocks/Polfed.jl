...
struct BenchmarkReport
    ...
    function BenchmarkReport(fact_report::FactorizationReport, total_wt::Real, total_ct::Real, x0::AbstractVecOrMat{T},pu::ProcessingUnit) where {T<:Number}
        # --- Timings ---
        ...
        """Local helper that estimates memory usage for CPU or GPU basis/report state."""
...
function display_benchmark_report(report::BenchmarkReport, use_colors::Bool;
    ...
    """Local helper that formats seconds into `(value, unit)` pairs."""
