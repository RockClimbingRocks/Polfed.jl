...
Legacy Clenshaw parallelization methods retained for reference compatibility.
"""
function clenshaw(
    transform::ClenshawType, 
    Y::AbstractVecOrMat{<:Number}, 
...
"""Legacy serial/`NoParallel` overload of `clenshaw`."""
function clenshaw(
    transform::ClenshawType, 
...
Legacy workspace allocator retained for reference compatibility.
"""
