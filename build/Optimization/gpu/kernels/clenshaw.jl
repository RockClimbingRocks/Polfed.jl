...
Perform one in-place Clenshaw recurrence update for vector or matrix device
buffers under a single off-diagonal-value bucket mapping.
"""
...
"""Matrix-layout CUDA kernel overload of `clenshaw_recurrence_one_offdiag!`."""
function clenshaw_recurrence_one_offdiag!(
    b1::CuDeviceMatrix{T}, 
    b2::CuDeviceMatrix{T}, 
    b3::CuDeviceMatrix{T}, 
