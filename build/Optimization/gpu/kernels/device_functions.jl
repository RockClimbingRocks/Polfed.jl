...
"""
    mapping_state_i!(...)  (CUDA device function)

Compute per-index mapped value on GPU for packed off-diagonal representation.

Methods support vector and matrix-backed input layouts.
"""
...
"""
    mapping_state_i_offdiag!(...)  (CUDA device function)

Compute only off-diagonal contribution for one index on GPU.
"""
