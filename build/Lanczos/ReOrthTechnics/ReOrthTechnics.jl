...
Abstract strategy type controlling Lanczos reorthogonalization behavior.
"""
...
Full reorthogonalization at each iteration.
"""
...
Partial reorthogonalization strategy. Reorthogonalization is performed only on
selected iterations controlled by `skip`.
"""
...
Placeholder reorthogonalization strategy type for selective schemes.
"""
