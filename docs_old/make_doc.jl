...
files_to_leterate = [
    ...
    "src/documentation/2.Docs-FunctionReference.jl",
    "src/documentation/2.Docs-PolfedDefaults.jl",
    "src/documentation/2.Docs-DocumentationPractices.jl",
]
...
makedocs(
    ...
    pages = [
        ...
        "Documentation" => [
            ...
            "Function reference" => "documentation/generated/2.Docs-FunctionReference.md",
            "Polfed defaults" => "documentation/generated/2.Docs-PolfedDefaults.md",
            "Documentation practices" => "documentation/generated/2.Docs-DocumentationPractices.md",
